...
assert.match(history, /sandboxEnvironmentId/)
...
assert.match(sidebar, /sandboxDisplayNames=\{sandboxDisplayNames\}/)
assert.match(messageList, /entry\.sandboxEnvironmentId/)
assert.match(sidebar, /findLatestConversationRuntimeSelection\(response\.messages\)/)
assert.match(sidebar, /reconcileAvailableCanonicalComposerRuntimeSelection/)
...
assert.match(sidebar, /reconcileAvailableCanonicalComposerRuntimeSelection/)
assert.match(sidebar, /resolveConfirmedComposerModelProfileId/)
...
assert.match(sidebar, /model_profile_id: submissionModelProfileId \|\| undefined/)
...
assert.match(apiClient, /pending-inputs\/resume/)
assert.match(apiClient, /pending-inputs\/clear/)
assert.match(sidebar, /res\.blocked_by_run_status/)
assert.match(sidebar, /res\.can_resume/)
